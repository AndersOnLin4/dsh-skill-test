...
- 目录更名：`deepseek-web-v2` → `deepseek-web`（唯一主版本）；v1 原版归档至 `G:\harness\dsh-home\skills-archive\deepseek-web-v1\`。
- SKILL.md 去掉"-v2 /（v2 新增）"标注与 v1 回退表述；脚本路径统一为 `skills\deepseek-web\scripts\`。
